# -*- coding: utf-8 -*-
"""
Created on Tue Apr  9 17:16:42 2024
...
def parsearPerfiles(link):
    ...
    if statList:
        winrate = statList[3].find('span', {'class':'value'}).text[1:-2]
    ...
    player['peakRank'] = peakRank
    player['numWins'] = numberWins
    player['numLose'] = numberLose
    player['wr'] = winrate
    player['ACS'] = avgCS
    player['kdaRat'] = kdaRatio
    player['kpr'] = killsPerRound
    player['avgDR'] = avgDmgRound
    player['kills'] = kills
    player['deaths'] = deadths
